...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			<th class="td" scope="col" style="text-align:left;"><?php esc_html_e( 'Status', 'woo-infoplus-connect' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php esc_html_e( 'Carrier', 'woo-infoplus-connect' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php esc_html_e( 'Tracking Number', 'woo-infoplus-connect' ); ?></th>
		</tr>
	</thead>
	<tbody>
		...
		<?php foreach( $shipments as $shipment ) : ?>
			...
			<tr>
				...
				<td  class="td" style="text-align:left; vertical-align:middle; border: 1px solid #eee; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap:break-word;"><?php echo esc_html( $shipment->get_status() ); ?></td>

				<td  class="td" style="text-align:left; vertical-align:middle; border: 1px solid #eee; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap:break-word;"><?php echo esc_html( ( $carrier = $shipment->get_carrier() ) ? $carrier : esc_html__( 'N/A', 'woo-infoplus-connect' ) ); ?></td>
